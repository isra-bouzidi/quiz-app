...
public class QuestionActivity7 extends AppCompatActivity {
    ...
    String[] questions = {
            "Quelle balise est utilisée pour créer un lien hypertexte en HTML/XML ?",
            "Comment définit-on un élément racine en XML ?",
            "Quel attribut est utilisé pour donner un identifiant unique à un élément XML ?"
    };

    String[] options = {
            "<a>","<link>","<href>","<url>",
            "root","xml","main","document",
            "id","name","key","uid"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Intent intent = new Intent(QuestionActivity7.this, ResultActivity7.class);
