...
public class QuestionActivity2 extends AppCompatActivity {
    ...
    String[] questions = {
            "Kotlin est-il entièrement interopérable avec Java ?",
            "Quel mot-clé Kotlin est utilisé pour déclarer une variable immuable ?",
            "Comment définit-on une fonction en Kotlin ?"
    };

    String[] options = {
            "Oui, totalement","Non","Partiellement","Aucune idée",
            "val","var","let","const",
            "fun maFonction()","function maFonction()","def maFonction()","func maFonction()"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Intent intent = new Intent(QuestionActivity2.this, ResultActivity2.class);
