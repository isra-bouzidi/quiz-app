...
public class QuestionActivity6 extends AppCompatActivity {
    ...
    String[] questions = {
            "Quelle commande SQL permet de récupérer toutes les lignes d'une table ?",
            "Quelle clause est utilisée pour filtrer les résultats d'une requête ?",
            "Comment supprime-t-on une table en SQL ?"
    };

    String[] options = {
            "SELECT * FROM table;","GET ALL FROM table;","SHOW TABLE;","FETCH * FROM table;",
            "WHERE","FILTER BY","HAVING","GROUP BY",
            "DROP TABLE table_name;","DELETE table_name;","REMOVE TABLE table_name;","ERASE TABLE table_name;"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Intent intent = new Intent(QuestionActivity6.this, ResultActivity6.class);
