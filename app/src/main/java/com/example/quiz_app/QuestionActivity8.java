...
public class QuestionActivity8 extends AppCompatActivity {
    ...
    String[] questions = {
            "Quelle fonction est utilisée pour afficher du texte à l'écran en C ?",
            "Quel symbole est utilisé pour terminer une instruction en C ?",
            "Comment déclare-t-on une variable entière en C ?"
    };

    String[] options = {
            "printf()","echo()","cout","print()",
            ";",":","!",".",
            "int x;","integer x;","var x;","num x;"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Intent intent = new Intent(QuestionActivity8.this, ResultActivity8.class);
